...
import {API_URL} from "../environment/environment.service";
...
export class AuthService {
  ...
  constructor(@Inject(API_URL) environment: IEnvironmentInterface, private http: HttpClient, private router: Router) {
